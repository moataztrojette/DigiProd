...
const ModalAdd = (props) => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        formData.append("etatCommande", props.valuesInput.etatCommande);
        formData.append("fichier", props.valuesInput.fichier);
    
        const data = await axios.post(
          "http://localhost:4000/api/commande/post",
          formData,
          {
            headers: {
        ...
        const preventState = props.commande;
        preventState.push(data.data);
        props.setCommande(preventState);
        };
