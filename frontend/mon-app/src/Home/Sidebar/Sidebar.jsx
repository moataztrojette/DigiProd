        ...
        <ul className="nav">
          ...
          <li className="nav-item">
            ...
            <div className="collapse" id="ui-basic2">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <a className="nav-link" href="#">Calendrier</a></li>
          ...
          <li className="nav-item">
            ...
            <div className="collapse" id="general-pages">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <a className="nav-link" href="#"> Factures </a></li>
                <li className="nav-item"> <a className="nav-link" href="#"> Recu </a></li>
          ...
          <li className="nav-item">
            ...
            <div className="collapse" id="ui-basic5">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <a className="nav-link" href="#">Suivie</a></li>
                <li className="nav-item"> <a className="nav-link" href="#">Rapport</a></li>
              </ul>
            </div>
          </li>
