...
const Client = () => { 
    ...
    useEffect(()=>{
        const data = axios.get("http://localhost:4000/api/client/findall").then((client)=>{
    ...
    const handleFormSubmit = async(event)=>{
        try{
            ...
            const data =await axios.post("http://localhost:4000/api/client/post",valuesInput)
    ...
    const deletedClient = async (id)=>{
        ...
        await axios.delete("http://localhost:4000/api/client/deleted/" + id)
        .then((verife)=>{
      ...
      const  handleFormSubmitUpdate =  async (event)=>{
            try{
                ...
                event.preventDefault()
                const dataClient = await axios.put("http://localhost:4000/api/client/update/" + valuesInput_update._id,valuesInput_update)  
...
<h3>Clients</h3>
  ...
  <div className="serhceInput">
    ...
    <button type="button"
 className="btn btn-primary-color_inv" onClick={() => setModalIsOpen(true)}>Nouveau Client + </button>
  </div>
</div>

<div className="row">

{client.length> 0 ?    <div className="title_Client">
    <ul>
