    ...
    return ( 
      ...
      <br />
                ...
                <form action="#" onSubmit={handleFormSubmit}>
                  ...
                  <h6>Nom de l'entreprise
                  </h6>
                  <div class="form-group first success">
                    <input type="text" class="form-control" id="nom_entreprise" name="nom_entreprise" placeholder="Ulysee media" required onChange={MyValueInput}/>
                  </div>
                  <br></br>
    
                  
                  <h6>URL de l'espace de travail
                  </h6>
                
                  <div class="form-group first  mb-3 success" >
                    <input type="url" class="form-control" id="url" name="url_espace" placeholder="http://www.digiprod.com/UM" required onChange={MyValueInput}/>
                  </div>
                  <h6>Langue
                  </h6>
                  <div class="form-group first success">
              
                  <select class="form-select" name="langue"  onChange={MyValueInput}>
                      ...
                      <div class="condition">
                            ...
                            <div class="form-check">
                                <input class="form-check-input2" type="checkbox" required name="checkbox" value="true"  id="flexCheckDefault" onChange={MyValueInput}/>
                            </div>
                  ...
                  <div class="form-group last mb-3">
                    <input type="submit" class="form-control" id="button" value="Terminer"/>
                  </div>
                  </form>
